...
module.exports = function(locals) {
    ...
    var posts = locals.posts.toArray()
        .filter(function(post) {
            return post.slide !== undefined || post.slide === true;
        }
    );

    posts.forEach(function(_post) {
        var postConfig = _post.slidehtml;
        var pageData = _post._content;
        if(postConfig.titleMerge === true || (postConfig.titleMerge === undefined && pluginConfig.titleMerger === true))
